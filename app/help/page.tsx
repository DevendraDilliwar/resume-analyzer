      ...
      <div className="flex-grow pt-24 pb-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h1 className="text-4xl font-bold font-sans text-foreground mb-4">Help Desk & Support</h1>
            <p className="text-muted-foreground font-body max-w-2xl mx-auto">
              Need assistance? We are here to help. Reach out to us for technical support or general inquiries.
            </p>
          </div>
            ...
            <div className="space-y-6">
              <Card className="border-border">
                <CardHeader>
                  ...
                  <CardDescription>For immediate danger, call 112.</CardDescription>
                </CardHeader>
              ...
              <Card className="border-border">
                ...
                <CardContent className="space-y-4 text-sm">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <p className="font-medium text-foreground">CrimeWatch India HQ</p>
                      <p className="text-muted-foreground">DLF Cyber City, Phase 2<br/>Gurugram, Haryana 122002</p>
                    </div>
                  </div>
                  <div className="flex items-center space-x-3">
                    <Mail className="w-5 h-5 text-muted-foreground" />
                    <span className="text-muted-foreground">support@crimewatch.in</span>
                  </div>
                  <div className="flex items-center space-x-3">
